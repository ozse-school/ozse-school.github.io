...
function Venue({ id }) {
  return (
    <div
      ...
      id={id}
    >
      <div className="flex flex-col pt-12 space-y-8 sm:px-0 w-full max-w-6xl">
        <div className="flex flex-col pt-12 space-y-8 sm:px-0">
          <h1 className="text-left text-3xl sm:text-4xl font-bold">Venue</h1>
        </div>
