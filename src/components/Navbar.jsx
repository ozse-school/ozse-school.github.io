...
function Navbar() {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 px-4 py-3 shadow-md transition-colors duration-300 ${isTop ? "md:bg-transparent bg-[#000F46] text-white" : "bg-[#000F46] text-white"
    ...
    >
      ...
      <div
        id="mobile-menu"
        className={`md:hidden fixed top-10 left-0 w-full ${isTop ? "md:bg-transparent bg-[#000F46]" : "bg-[#000F46]/95 backdrop-blur-sm"
          } shadow-lg transform transition-transform duration-300 ease-in-out origin-top ${isOpen ? "scale-y-100" : "scale-y-0"
          }`}
